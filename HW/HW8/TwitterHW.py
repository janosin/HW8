...
##YOUR CODE HERE
    if "umsi" in CACHE_DICTION:
        ...
        twitter_results = CACHE_DICTION["umsi"] #uses data already in cache
    else:
        print("Fetching")
        twitter_results = api.user_timeline("umsi") #fetches new data using the api
...
more_than_two = cur.fetchall()
print ("more_than_two - %s ") % set(more_than_two)
